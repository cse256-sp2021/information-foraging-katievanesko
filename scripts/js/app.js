...
function PutStudentPageLoadOperationsInsideThisStudentBody() {
    ...
    if (document.body.contains(home)) {
        alert("MINIMIZE BANNER TO SEE FULL PAGE (using button in top right corner)");
    }
}
